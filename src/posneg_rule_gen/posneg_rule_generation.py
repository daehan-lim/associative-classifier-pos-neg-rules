    ...
    for c in classes:
        if not c.issubset(itemset):
            ...
            if r > corr:  # generate positive rule
                ...
                combined_support_count_nr1 = util.get_item_support_count_df(itemset | c, transactions_df)  # fix
                combined_support_count_nr2 = util.get_item_support_count_df(itemset | c, transactions_df)
